		...
		<div class="header-left header-left1">
			...
			<div class="top-nav">
				<ul >
					...
					<li class="active"><a href="about.html" class="black1"> ABOUT</a></li>
		...
		<div class="content">
			<div class="about">
				<div class="about-top">
					...
					<h2><a href="single.html">Who We Are</a></h2>
					...
					<span>Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi. Proin condimentum fermentum nunc. Etiam pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Suspendisse in orci enim.</span></p>
				<div class="staff">
					<h3>Our Staff</h3>
						<div class="our">
						<a href="single.html"><img  src="images/p3.jpg" />
							<div class="simple">
								<h4>John Smith</h4>
								<p>Web Developer</p>
							</div>
						...
						<div class="our">
							<a href="single.html"><img  src="images/p2.jpg" />
							<div class="simple">
								<h4>John Smith</h4>
								<p>Web Developer</p>
							</div>
						...
						<div class="our">
						<a href="single.html"><img  src="images/p4.jpg" />
							<div class="simple">
								<h4>John Smith</h4>
								<p>Web Developer</p>
							</div>
						...
						<div class="our">
						<a href="single.html"><img  src="images/p5.jpg" />
							<div class="simple">
								<h4>John Smith</h4>
								<p>Web Developer</p>
							</div>
						...
						<div class="our">
						<a href="single.html"><img  src="images/p6.jpg" />
							<div class="simple">
								<h4>John Smith</h4>
								<p>Web Developer</p>
							</div>
				...
				<div class="about-in">
					...
					<div class="test">
						...
						<div class="test-top">
							<div class="test-in">
								<img class="in-at"  src="images/p6.jpg" />
