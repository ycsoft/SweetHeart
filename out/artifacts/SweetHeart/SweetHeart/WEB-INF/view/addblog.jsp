...
$(document).ready(function(e) {
	...
	$('#submit').click(function(e) {
        ...
        alert(ehtml);
        $('textarea').val(ehtml);
        var url = "/SweetHeart/addblog?title="+title+"&data="+ehtml+"&img=123";
...
<div id="btn"><input type="submit" value="提交" id="submit"/><input type="reset" name="clear" value="清空"/></div>
    ...
    <form action="/SweetHeart/upload" method="post" enctype="multipart/form-data" id="fileform">
        <input type="file" name="file" value="上传图片" id="file" />
