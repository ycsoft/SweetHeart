...
<meta name="keywords" content="杨小东 陈磊 杨慕尧"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(e){
		$("#continue").click(function(e){
			...
			var upwd = $("#pwd").val();
			upwd = $.md5(upwd);
			location.href = "/auth?name="+uname + "&pwd="+upwd;
		});
...
<div class="login-box">
	...
	<h2>七公主</h2>
		...
		<div class="btn"><input type="button" id="continue" value="Continue"></div>

		<div class="remember"><p>Not a Member?</p>
		<h4><a href="#">Sign up now<img src="static/images/arrow.png" /></a></h4>
		</div>
</div>
<!--//End-login-form-->
<!--start-copyright-->
